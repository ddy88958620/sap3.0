	...
	public Grid reportGrid(SuccessReportModel model) {
		...
		try {
			...
			for (Map<String, Object> map2 : list) {
				...
				String violation = df2.format((countLong * 1.0d / total) * 100) + "%";
...
//		Long countLong = new Long((long)1);
//		System.out.println(countLong * 1.0d);
//		System.out.println(countLong * 1.0d / 1600);
//		System.out.println((countLong * 1.0d / 1600) * 100 + "mhn");
//
//		DecimalFormat df2  = new DecimalFormat("##0.00");
//
//		System.out.println(df2.format((countLong * 1.0d / 1600) * 100) + "%");
//
////		String violation = ((countLong * 1.0d / 1600) * 100 + "")
////				.substring(0, 4) + "%";
//
