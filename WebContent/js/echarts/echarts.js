...
function(e) {
    ...
    function i() {
        function e(r, s) {
            if (!o[r] && !d(r, O)) {
                o[r] = 1,
                d(r, F) || n[r] || (n[r] = 1, t.push(r));
                var l = A[r];
                l ? s && (n[r] || (n[r] = 1, t.push(r)), T(l.depMs,
                function(t) {
                    e(t.absId, t.hard)
                })) : a[r] || (a[r] = 1, i.push(r))
            }
    ...
    function L(e) {
        function t(t, n) {
            if ("string" == typeof t) return i[t] || (i[t] = y(v(t, e))),
            i[t];
    ...
    function I() {
        ...
        for (var e = document.getElementsByTagName("script"), t = e.length; t--;) {
            var i = e[t];
            if ("interactive" === i.readyState) return et = i,
            i
        }
    }
    function K(e) {
    ...
    t.config = function(e) {
        ...
        if (e) {
            for (var i in G) {
                var n = e[i],
                a = G[i];
                if (n) if ("urlArgs" === i && "string" == typeof n) G.urlArgs["*"] = n;
                else if (a instanceof Array) T(n, t);
                else if ("object" == typeof a) for (var i in n) a[i] = n[i];
                else G[i] = n
            }
            _()
        }
    ...
    it && (tt = it.parentNode),
    e.define || (e.define = n, e.require || (e.require = t), e.esl = t)
} (this),
...
function(e) {
    ...
    s.init = function(t, n) {
        var a = e("zrender"); (a.version || "1.0.3").replace(".", "") - 0 < s.dependencies.zrender.replace(".", "") - 0 && console.error("ZRender " + (a.version || "1.0.3-") + " is too old for ECharts " + s.version + ". Current version need ZRender " + s.dependencies.zrender + "+"),
    ...
    return i.prototype = {
        ...
        _render: function(t) {
            ...
            V ? y[V] || (y[V] = !0, u = o.get(V), u ? (this.chart[V] ? (U = this.chart[V], U.refresh(t)) : U = new u(this._themeConfig, this._messageCenter, this._zr, t, this), this._chartList.push(U), this.chart[V] = U) : console.error(V + " has not been required.")) : console.error("series[" + c + "] chart type has not been defined.");
            ...
            t.renderAsImage && l ? (f ? f.src = this.getDataURL(t.renderAsImage) : (f = this.getImage(t.renderAsImage), f.id = g, f.style.position = "absolute", f.style.left = 0, f.style.top = 0, this.dom.firstChild.appendChild(f)), this.un(), this._zr.un(), this._disposeChartList(), this._zr.clear()) : f && f.parentNode.removeChild(f),
            f = null,
            this._option = t
        },
        restore: function() {
        ...
        addData: function(e, t, i, n, r) {
                ...
                if (c) {
                    ...
                    if (V[p](t), U[p](t), n || (V[u](), t = U[u]()), null != r) {
                        ...
                        if (c.type === a.CHART_TYPE_PIE && (y = h.legend) && (g = y.data)) {
                            var f = l.legend.data;
                            if (g[p](r), f[p](r), !n) {
                                var b = o.indexOf(g, t.name); - 1 != b && g.splice(b, 1),
                                b = o.indexOf(f, t.name),
                                -1 != b && f.splice(b, 1)
                            }
                        } else if (null != h.xAxis && null != h.yAxis) {
                            var _, x, k = c.xAxisIndex || 0; (null == h.xAxis[k].type || "category" === h.xAxis[k].type) && (_ = h.xAxis[k].data, x = l.xAxis[k].data, _[p](r), x[p](r), n || (_[u](), x[u]())),
                            k = c.yAxisIndex || 0,
                            "category" === h.yAxis[k].type && (_ = h.yAxis[k].data, x = l.yAxis[k].data, _[p](r), x[p](r), n || (_[u](), x[u]()))
                        }
                    }
            ...
            d = 0,
            m = L.length; m > d; d++) l.addDataAnimation && L[d].addDataAnimation && L[d].addDataAnimation(s);
            ...
            return setTimeout(function() {
                if (v._zr) {
                    ...
                    for (var e = 0,
                    t = L.length; t > e; e++) L[e].motionlessOnce = l.addDataAnimation && L[e].addDataAnimation;
...
function(e) {
    ...
    function o() {
        return c || (m = document.createElement("canvas"), p = m.width, u = m.height, c = m.getContext("2d")),
        c
    }
    function r(e, t) {
        var i, n = 100;
        e + U > p && (p = e + U + n, m.width = p, i = !0),
        t + y > u && (u = t + y + n, m.height = u, i = !0),
        -U > e && (U = Math.ceil( - e / n) * n, p += U, m.width = p, i = !0),
        -y > t && (y = Math.ceil( - t / n) * n, u += y, m.height = u, i = !0),
        i && c.translate(U, y)
    }
    function s() {
        return {
...
function() {
    function e(e) {
        ...
        g && (i.ie = !0, i.version = g[1]),
        f && (e.match(/Safari/) || t.ios) && (i.safari = !0),
        b && (i.webview = !0),
        g && (i.ie = !0, i.version = g[1]),
        t.tablet = !!(o || V || a && !e.match(/Mobile/) || y && e.match(/Tablet/) || g && !e.match(/Phone/) && e.match(/Touch/)),
        t.phone = !(t.tablet || t.ipod || !(a || s || l || c || p || U && e.match(/Android/) || U && e.match(/CriOS\/([\d.]+)/) || y && e.match(/Mobile/) || g && e.match(/Touch/))),
        {
            browser: i,
            os: t,
...
function(e) {
    ...
    return t.prototype = {
        ...
        ondragend: function(e, t) {
            var i = e.target;
            this.isDragend ? t.dragIn && (this.del(i), t.needRefresh = !0) : t.dragIn || (i.style.x = l.getX(e.event), i.style.y = l.getY(e.event), this.add(i), t.needRefresh = !0),
            this.isDragend = !1
        }
    },
    s.inherits(t, n),
...
function(e) {
    ...
    return t.prototype = {
        ...
        __onmousemove: function(e) {
            ...
            this._zooming && (this._zoomShape.style.width = d.getX(e.event) - this._zoomShape.style.x, this._zoomShape.style.height = d.getY(e.event) - this._zoomShape.style.y, this.zr.addHoverShape(this._zoomShape), this.dom.style.cursor = "crosshair"),
...
function(e) {
    ...
    return t.prototype = {
        ...
        refresh: function(e) {
            e && (this.option = e, this.option.title = this.reformOption(this.option.title), this.titleOption = this.option.title, this.titleOption.textStyle = r.merge(this.titleOption.textStyle, this.ecTheme.textStyle), this.titleOption.subtextStyle = r.merge(this.titleOption.subtextStyle, this.ecTheme.textStyle)),
            this.clear(),
            this._buildShape()
        }
    },
    ...
    return t.prototype = {
            ...
            if (h.length > 0) {
                if (this._lastDataIndex != i || this._lastSeriesIndex != m[0]) {
                    ...
                    if ("function" == typeof a) {
                        for (var x = [], y = 0, g = h.length; g > y; y++) b = h[y].data[i],
                        ...
                        for (var y = 0,
                        g = h.length; g > y; y++) a = a.replace("{a" + y + "}", this._encodeHTML(h[y].name || "")),
                        a = a.replace("{b" + y + "}", this._encodeHTML(n.getNameByIndex(i))),
                        b = h[y].data[i],
                        b = null != b ? null != b.value ? b.value: b: "-",
                        a = a.replace("{c" + y + "}", b instanceof Array ? b: this.numAddCommas(b));
                        this._tDom.innerHTML = a
                    } else {
                        this._curTicket = 0 / 0,
                        a = this._encodeHTML(n.getNameByIndex(i));
                        for (var y = 0,
                        g = h.length; g > y; y++) a += "<br/>" + this._encodeHTML(h[y].name || "") + " : ",
                        b = h[y].data[i],
                        b = null != b ? null != b.value ? b.value: b: "-",
        ...
        _showPolarTrigger: function(e, t) {
            ...
            if (r.length > 0) {
                ...
                if (this._lastDataIndex != t || this._lastSeriesIndex != s[0]) if (this._lastDataIndex = t, this._lastSeriesIndex = s[0], "function" == typeof i) this._curTicket = "axis:" + t,
        ...
        _showItemTrigger: function(e) {
            if (this._curTarget) {
                ...
                if ("island" != this._curTarget._type) {
                    var U = e ? "axis": "item";
                    this.option.tooltip.trigger === U && (t = this.option.tooltip.formatter, i = this.option.tooltip.position),
                    this.query(a, "tooltip.trigger") === U && (n = this.query(a, "tooltip.showContent") || n, t = this.query(a, "tooltip.formatter") || t, i = this.query(a, "tooltip.position") || i, V += this._style(this.query(a, "tooltip"))),
                    n = this.query(r, "tooltip.showContent") || n,
                    t = this.query(r, "tooltip.formatter") || t,
                    i = this.query(r, "tooltip.position") || i,
                    V += this._style(this.query(r, "tooltip"))
                } else this._lastItemTriggerId = 0 / 0,
                n = this.deepQuery([r, a, this.option], "tooltip.showContent"),
                t = this.deepQuery([r, a, this.option], "tooltip.islandFormatter"),
                i = this.deepQuery([r, a, this.option], "tooltip.islandPosition");
                ...
                this._axisLineShape.invisible && this._axisShadowShape.invisible || (this._axisLineShape.invisible = !0, this.zr.modShape(this._axisLineShape.id), this._axisShadowShape.invisible = !0, this.zr.modShape(this._axisShadowShape.id), this.zr.refresh()),
                n !== !1 && this.option.tooltip.showContent && (this.hasAppend || (this._tDom.style.left = this._zrWidth / 2 + "px", this._tDom.style.top = this._zrHeight / 2 + "px", this.dom.firstChild.appendChild(this._tDom), this.hasAppend = !0), this._show(i, d.getX(this._event) + 20, d.getY(this._event) - 20, V))
            }
        },
        _itemFormatter: {
        ...
        _styleAxisPointer: function(e, t, i, n, a, o, r, s) {
            if (e.length > 0) {
                ...
                for (var u = 0,
                V = e.length; V > u; u++)"axis" === this.deepQuery([e[u], this.option], "tooltip.trigger") && (l = e[u], h = this.query(l, "tooltip.axisPointer.type"), m = h || m, h && (c[h].color = this.query(l, "tooltip.axisPointer." + h + "Style.color") || c[h].color, c[h].width = this.query(l, "tooltip.axisPointer." + h + "Style.width") || c[h].width, c[h].type = this.query(l, "tooltip.axisPointer." + h + "Style.type") || c[h].type));
        ...
        ontooltipHover: function(e, t) {
            if (!this._lastTipShape || this._lastTipShape && this._lastTipShape.dataIndex != e.dataIndex) {
                ...
                for (var i = 0,
                n = t.length; n > i; i++) t[i].zlevel = this._zlevelBase,
                ...
                if (null != r) {
                    ...
                    if (d) if (m) {
                        ...
                        case s.CHART_TYPE_SCATTER:
                            ...
                            a = 0,
                            o = f.length; o > a; a++) if (l.get(f[a], "seriesIndex") == t && l.get(f[a], "dataIndex") == c) {
                                this._curTarget = f[a],
                                y = f[a].style.x,
                                g = d.type != s.CHART_TYPE_K ? f[a].style.y: f[a].style.y[0];
                                break
                            }
                            break;
                        case s.CHART_TYPE_RADAR:
                        ...
                        case s.CHART_TYPE_PIE:
                            ...
                            o = f.length; o > a; a++) if ("sector" === f[a].type && l.get(f[a], "seriesIndex") == t && l.get(f[a], "name") == b) {
                                ...
                                y = this._curTarget.style.x + Math.cos(x) * _.r / 1.5,
                                g = this._curTarget.style.y - Math.sin(x) * _.r / 1.5;
                                break
                            }
                            break;
                        case s.CHART_TYPE_MAP:
                            ...
                            o = f.length; o > a; a++) if ("text" === f[a].type && f[a]._mapType === k && f[a].style._name === b) {
                                ...
                                g = this._curTarget.style.y + this._curTarget.position[1];
                                break
                            }
                            break;
                        case s.CHART_TYPE_CHORD:
                            ...
                            o = f.length; o > a; a++) if ("sector" === f[a].type && l.get(f[a], "name") == b) {
                                ...
                                var _ = this._curTarget.style,
                                x = (_.startAngle + _.endAngle) / 2 * Math.PI / 180;
                                return y = this._curTarget.style.x + Math.cos(x) * (_.r - 2),
                                g = this._curTarget.style.y - Math.sin(x) * (_.r - 2),
    ...
    t.prototype = {
        ...
        _getItemGroupLocation: function() {
            ...
            if ("horizontal" === this.legendOption.orient) {
                l = a;
                for (var U = 0; t > U; U++)"" !== this._getName(e[U]) ? u += n + d.getTextWidth(this._getFormatterNameFromData(e[U]), e[U].textStyle ? this.getFont(h.merge(e[U].textStyle || {},
                o)) : r) + i: (u -= i, u > c ? (s = c, l += a + i) : s = Math.max(s, u), l += a + i, u = 0);
                l = Math.max(l, a),
                u -= i,
                u > c ? (s = c, l += a + i) : s = Math.max(s, u)
            } else {
...
function(e) {
    ...
    function h(e, t, i) {
        ...
        e = K(e),
        t = K(t);
        for (var n = [], a = (t[0] - e[0]) / i, o = (t[1] - e[1]) / i, r = (t[2] - e[2]) / i, s = (t[3] - e[3]) / i, l = 0, h = e[0], d = e[1], c = e[2], p = e[3]; i > l; l++) n[l] = m([C(Math.floor(h), [0, 255]), C(Math.floor(d), [0, 255]), C(Math.floor(c), [0, 255]), p.toFixed(4) - 0], "rgba"),
        h += a,
        d += o,
        c += r,
        p += s;
...
function(e) {
    ...
    return t.prototype = {
        ...
        _getChainPoint: function() {
            ...
            for (var y, g, f, b, _, x = [], U = 0; p > U; U++) d = u[U],
            y = h[U].symbol && h[U].symbol.toLowerCase() || n,
            y.match("empty") ? (y = y.replace("empty", ""), f = !0) : f = !1,
            y.match("star") && (g = y.replace("star", "") - 0 || 5, y = "star"),
        ...
        play: function(e, t) {
            return this._ctrPlayShape && "playing" != this._ctrPlayShape.style.status && (this._ctrPlayShape.style.status = "playing", this.zr.modShape(this._ctrPlayShape.id), this.zr.refresh()),
        ...
        stop: function() {
            return this._ctrPlayShape && "stop" != this._ctrPlayShape.style.status && (this._ctrPlayShape.style.status = "stop", this.zr.modShape(this._ctrPlayShape.id), this.zr.refresh()),
        ...
        setTheme: function(e) {
            ...
            this.timelineOption.label.textStyle = l.merge(this.timelineOption.label.textStyle || {},
            this.ecTheme.textStyle),
            this.timelineOption.checkpointStyle.label.textStyle = l.merge(this.timelineOption.checkpointStyle.label.textStyle || {},
            this.ecTheme.textStyle),
...
function(e) {
    ...
    t.prototype._start = function(e, t) {
        ...
        if (null != i.progress) {
            ...
            y.highlightStyle.text = 5 * k + "%",
            e(y);
            for (var x = 0; 20 > x; x++) g[x].highlightStyle.color = k > x ? g[x]._color: U,
            e(g[x]);
            return e(h),
            void t()
        }
        return setInterval(function() {
            ...
            k += k >= 20 ? -20 : 1,
            e(y);
            for (var i = 0; 20 > i; i++) g[i].highlightStyle.color = k > i ? g[i]._color: U,
            e(g[i]);
            e(h),
            t()
        },
...
function(e) {
    ...
    t.prototype._start = function(e, t) {
        ...
        g = [0, c.x, c.y];
        return V.highlightStyle.x = U.highlightStyle.x = y.highlightStyle.x = g[1],
        V.highlightStyle.y = U.highlightStyle.y = y.highlightStyle.y = g[2],
    ...
    function() {
        ...
        function k(e, t, i, n) {
            ...
            if (a instanceof w) {
                ...
                for (var v = k.length,
                W = k[0].color, I = k[v - 1].color, K = k[0].alpha * e.globalAlpha, S = k[v - 1].alpha * e.globalAlpha, C = [], E = 0; v > E; E++) {
                    var A = k[E];
        ...
        q.drawImage = function(e) {
            ...
            if (u.push(" <g_vml_:group", ' coordsize="', J * V, ",", J * U, '"', ' coordorigin="0,0"', ' style="width:', V, "px;height:", U, "px;position:absolute;"), 1 != this.m_[0][0] || this.m_[0][1] || 1 != this.m_[1][1] || this.m_[1][0]) {
                ...
                u.push("padding:0 ", C(b.x / J), "px ", C(b.y / J), "px 0;filter:progid:DXImageTransform.Microsoft.Matrix(", g.join(""), ", SizingMethod='clip');")
            } else u.push("top:", C(p.y / J), "px;left:", C(p.x / J), "px;");
            u.push(' ">'),
            (o || r) && u.push('<div style="overflow: hidden; width:', Math.ceil((n + o * n / s) * y), "px;", " height:", Math.ceil((a + r * a / l) * f), "px;", " filter:progid:DxImageTransform.Microsoft.Matrix(Dx=", -o * n / s * y, ",Dy=", -r * a / l * f, ');">'),
            u.push('<div style="width:', Math.round(y * m * n / s), "px;", " height:", Math.round(f * c * a / l), "px;", " filter:"),
...
function(e) {
    ...
    u = {
        ...
        click: function(e) {
            ...
            var t = this._lastHover; (t && t.clickable || !t) && this._clickThreshold < 5 && this._dispatchAgency(t, m.CLICK, e),
            this._mousemoveHandler(e)
        },
        dblclick: function(e) {
            e = e || window.event,
            e = this._zrenderEventFixed(e);
            var t = this._lastHover; (t && t.clickable || !t) && this._clickThreshold < 5 && this._dispatchAgency(t, m.DBLCLICK, e),
            this._mousemoveHandler(e)
        },
        ...
        touchend: function(e) {
            ...
            var t = new Date;
            t - this._lastTouchMoment < m.touchClickDelay && (this._mobildFindFixed(e), this._clickHandler(e), t - this._lastClickMoment < m.touchClickDelay / 2 && (this._dblclickHandler(e), this._lastHover && this._lastHover.clickable && s.stop(e)), this._lastClickMoment = t),
...
function(e) {
    ...
    p.prototype.resize = function(e, t) {
        ...
        1 != d && this.ctx.scale(d, d),
        this.domBack && (this.domBack.setAttribute("width", e * d), this.domBack.setAttribute("height", t * d), 1 != d && this.ctxBack.scale(d, d))
    },
                ...
                if (U) {
                    ...
                    if (U) {
                        ...
                        var A = function(e, o) {
                            ...
                            var d = x[L + 1] - x[L];
                            if (0 !== d) {
                                if (w = (o - x[L]) / d, c) if (I = k[L], X = k[0 === L ? L: L - 1], K = k[L > U - 2 ? U - 1 : L + 1], S = k[L > U - 3 ? U - 1 : L + 2], g) r(X, I, K, S, w, w * w, w * w * w, l(e, V), b);
                                else {
                                    var m;
    ...
    return s.prototype = {
            ...
            if (this.updateNeedTransform(), this.needTransform = this.parent ? this.needLocalTransform || this.parent.needTransform: this.needLocalTransform, this.needTransform) {
                ...
                if (n.identity(e), this.needLocalTransform) {
                    if (i(this.scale[0]) || i(this.scale[1])) {
                        ...
                        t && (o[0] = -o[0], o[1] = -o[1], n.translate(e, e, o))
                    }
                    ...
                    } else 0 !== this.rotation && n.rotate(e, e, this.rotation); (i(this.position[0]) || i(this.position[1])) && n.translate(e, e, this.position)
                }
                this.transform = e,
        ...
        lookAt: function() {
            ...
            return function(i) {
                ...
                t(e[0]) && t(e[1]) || (a.normalize(e, e), o[2] = e[0] * this.scale[1], o[3] = e[1] * this.scale[1], o[0] = e[1] * this.scale[0], o[1] = -e[0] * this.scale[0], o[4] = this.position[0], o[5] = this.position[1], this.decomposeTransform())
            }
        } (),
...
function(e) {
    ...
    function b(e, i, n, a, o, r, s, l) {
        ...
        c = 0; 2 > c; c++) {
            ...
            if (p + e > s) {
                ...
                d = r ? 1 : -1;
                0 > u && (u = T + u),
                (u >= a && o >= u || u + T >= a && o >= u + T) && (u > Math.PI / 2 && u < 1.5 * Math.PI && (d = -d), m += d)
            }
        }
        return m
    }
    function _(e, t, i, n, a) {
        ...
        x = 0; x < e.length; x++) {
            ...
            case "C":
                ...
                _ && (o += g(d, m, L[0], L[1], L[2], L[3], L[4], L[5], n, a)),
                d = L[4],
                m = L[5];
                break;
            case "Q":
    ...
    function x(e, t) {
        ...
        for (var n = 0,
        a = 0,
        o = e.length; o > a; a++) n = Math.max(L.measureText(e[a]).width, n);
        return L.restore(),
        w[i] = n,
        ++I > S && (I = 0, w = {}),
        n
...
function(e) {
    ...
    d.prototype.getTansform = function() {
        ...
        return function(t, i) {
            var n = [t, i];
            return this.needTransform && this.transform && (a.invert(e, this.transform), a.mulVector(n, e, [t, i, 1]), t == n[0] && i == n[1] && this.updateNeedTransform()),
            n
        }
    } (),
    ...
    return t.prototype = {
        ...
        ondrop: function(e, t) {
            if (this.isDrop && e.target && !t.dragIn) {
                ...
                if ( - 1 === l) {
                    if (s.get(a, "seriesIndex") == o) return t.dragOut = t.dragIn = t.needRefresh = !0,
                    void(this.isDrop = !1);
                    i = {
                        value: s.get(a, "value"),
                        name: s.get(a, "name")
                    ...
                    for (var c = !1,
                    p = h[o].data, u = 0, V = p.length; V > u; u++) p[u].name === i.name && "-" === p[u].value && (h[o].data[u].value = i.value, c = !0); ! c && h[o].data.push(i),
                    m && m.add(i.name, a.style.color || a.style.strokeColor)
                } else i = this.option.series[o].data[l] || "-",
                null != i.value ? (this.option.series[o].data[l].value = "-" != i.value ? d.accAdd(this.option.series[o].data[l].value, s.get(a, "value")) : s.get(a, "value"), (this.type === r.CHART_TYPE_FUNNEL || this.type === r.CHART_TYPE_PIE) && (m && 1 === m.getRelatedAmount(i.name) && this.component.legend.del(i.name), i.name += this.option.nameConnector + s.get(a, "name"), m && m.add(i.name, a.style.color || a.style.strokeColor))) : this.option.series[o].data[l] = "-" != i ? d.accAdd(this.option.series[o].data[l], s.get(a, "value")) : s.get(a, "value");
                t.dragIn = t.dragIn || !0,
                this.isDrop = !1;
                var U = this;
                setTimeout(function() {
        ...
        addLabel: function(e, t, i, n, a) {
            ...
            l = r.textStyle || {},
            h = s.textStyle || {};
            return r.show && (e.style.text = this._getLabelText(t, i, n, "normal"), e.style.textPosition = null == r.position ? "horizontal" === a ? "right": "top": r.position, e.style.textColor = l.color, e.style.textFont = this.getFont(l)),
            s.show && (e.highlightStyle.text = this._getLabelText(t, i, n, "emphasis"), e.highlightStyle.textPosition = r.show ? e.style.textPosition: null == s.position ? "horizontal" === a ? "right": "top": s.position, e.highlightStyle.textColor = h.color, e.highlightStyle.textFont = this.getFont(h)),
            e
        },
        ...
        _buildMarkPoint: function(e) {
            for (var t, i, n = (this.markAttachStyle || {})[e], a = this.series[e], o = this.getZlevelBase(), s = m.clone(a.markPoint), l = 0, h = s.data.length; h > l; l++) t = s.data[l],
            i = this.getMarkCoord(e, t),
            s.data[l].x = null != t.x ? t.x: i[0],
            s.data[l].y = null != t.y ? t.y: i[1],
            !t.type || "max" !== t.type && "min" !== t.type || (s.data[l].value = i[3], s.data[l].name = t.name || t.type, s.data[l].symbolSize = s.data[l].symbolSize || c.getTextWidth(i[3], this.getFont()) / 2 + 5);
            for (var d = this._markPoint(e, s), l = 0, h = d.length; h > l; l++) {
                d[l].zlevel = o + 1;
                for (var p in n) d[l][p] = m.clone(n[p]);
                this.shapeList.push(d[l])
            }
            if (this.type === r.CHART_TYPE_FORCE || this.type === r.CHART_TYPE_CHORD) for (var l = 0,
            h = d.length; h > l; l++) this.zr.addShape(d[l])
        },
        _buildMarkLine: function(e) {
            for (var t, i, n = (this.markAttachStyle || {})[e], a = this.series[e], o = this.getZlevelBase(), s = m.clone(a.markLine), l = 0, h = s.data.length; h > l; l++) t = s.data[l],
            !t.type || "max" !== t.type && "min" !== t.type && "average" !== t.type ? i = [this.getMarkCoord(e, t[0]), this.getMarkCoord(e, t[1])] : (i = this.getMarkCoord(e, t), s.data[l] = [m.clone(t), {}], s.data[l][0].name = t.name || t.type, s.data[l][0].value = i[3], i = i[2], t = [{},
            {}]),
            null != i && null != i[0] && null != i[1] && (s.data[l][0].x = null != t[0].x ? t[0].x: i[0][0], s.data[l][0].y = null != t[0].y ? t[0].y: i[0][1], s.data[l][1].x = null != t[1].x ? t[1].x: i[1][0], s.data[l][1].y = null != t[1].y ? t[1].y: i[1][1]);
        ...
        _markPoint: function(e, t) {
            ...
            g = this.zr.getWidth(),
            f = this.zr.getHeight();
            if (t.large) a = this.getLargeMarkPoingShape(e, t),
            a._mark = "largePoint",
            a && u.push(a);
            else for (var b = 0,
            _ = V.length; _ > b; b++) null != V[b].x && null != V[b].y && (l = null != V[b] && null != V[b].value ? V[b].value: "", y && (o = y.getColor(i.name)), U && (o = isNaN(l) ? o: U.getColor(l), h = [V[b], t], d = this.deepQuery(h, "itemStyle.normal.color") || o, c = this.deepQuery(h, "itemStyle.emphasis.color") || d, null == d && null == c) || (o = null == o ? this.zr.getColor(e) : o, V[b].tooltip = V[b].tooltip || t.tooltip || {
                trigger: "item"
            },
        ...
        getSymbolShape: function(e, t, a, o, r, l, h, d, m, c, p) {
            ...
            null != y && (x.rotation = [y * Math.PI / 180, l, h]),
            d.match("star") && (x.style.iconType = "star", x.style.n = d.replace("empty", "").replace("star", "") - 0 || 5),
            "none" === d && (x.invisible = !0, x.hoverable = !1),
            x = this.addLabel(x, e, a, r, p),
            d.match("empty") && (null == x.style.textColor && (x.style.textColor = x.style.strokeColor), null == x.highlightStyle.textColor && (x.highlightStyle.textColor = x.highlightStyle.strokeColor)),
            s.pack(x, e, t, a, o, r),
            x._x = l,
            x._y = h,
            x._dataIndex = o,
        ...
        addShapeList: function() {
            ...
            if (this.option.animation && !this.option.renderAsImage && a.length < i && !this.motionlessOnce) {
                for (var d = 0,
                m = n.length; m > d; d++) t = this._getAnimationKey(n[d]),
                t.match("undefined") ? this.zr.delShape(n[d].id) : (t += n[d].type, l[t] = n[d]);
                for (var d = 0,
                m = a.length; m > d; d++) t = this._getAnimationKey(a[d]),
                t.match("undefined") ? this.zr.addShape(a[d]) : (t += a[d].type, h[t] = a[d]);
                ...
                this.zr.delShape(n);
                for (var d = 0,
                m = a.length; m > d; d++) this.zr.addShape(a[d])
            }
        },
        ...
        animationMark: function(e, t, i) {
            for (var n = i || this.shapeList,
            a = 0,
            o = n.length; o > a; a++) n[a]._mark && this._animateMod(!1, n[a], e, t);
        ...
        animationEffect: function(e) { ! e && this.clearEffectShape();
            ...
            if (null != t) {
                ...
                for (var n, a = 0,
                o = t.length; o > a; a++) n = t[a],
                n._mark && n.effect && n.effect.show && h[n._mark] && (h[n._mark](this.zr, this.effectList, n, i), this.effectList[this.effectList.length - 1]._mark = n._mark)
            }
        },
        ...
        delMark: function(e, t, i) {
            ...
            if (this.selectedMap[n.name]) {
                for (var a = !1,
                o = [this.shapeList, this.effectList], r = 2; r--;) for (var l = 0,
                h = o[r].length; h > l; l++) if (o[r][l]._mark == i && s.get(o[r][l], "seriesIndex") == e && s.get(o[r][l], "name") == t) {
...
function(e) {
    ...
    function p(e, t) {
        ...
        a = t.width,
        o = t.height,
        r = Math.round(o / 3), s = 3; s--;) e.rect(i, n + r * s + 2, a, 2)
    }
    function u(e, t) {
        for (var i = t.x,
        n = t.y,
        a = t.width,
        o = t.height,
        r = Math.round(a / 3), s = 3; s--;) e.rect(i + r * s, n, 2, o)
    }
    function V(e, t) {
        var i = t.x,
        n = t.y,
...
function(e) {
    ...
    return t.prototype = {
        ...
        brush: function(e, t) {
            ...
            e.save(),
            e.beginPath(),
            this.buildLinePath(e, i, this.style.lineWidth || 1),
            e.stroke(),
            e.restore(),
        ...
        buildLinePath: function(e, t, i) {
            ...
            if (t.lineType && "solid" != t.lineType) {
                ...
                } else for (var r = 1; a > r; r += 2) e.moveTo(n[r - 1][0], n[r - 1][1]),
                e.lineTo(n[r][0], n[r][1])
            } else {
                e.moveTo(n[0][0], n[0][1]);
        ...
        buildArrawPath: function(e, t, i) {
            ...
            e.moveTo(c, p);
            for (var V = 0,
            U = u.length; U > V; V++) e.lineTo(u[V][0], u[V][1]);
            e.lineTo(c, p)
        },
        ...
        getOffetPoint: function(e, t) {
            ...
            var s, l;
            return e[0] <= t[0] ? (i -= o, s = Math.round(Math.cos(i) * n), l = Math.round(Math.sin(i) * n), a[0] += s, a[1] += l) : (i += o, s = Math.round(Math.cos(i) * n), l = Math.round(Math.sin(i) * n), a[0] -= s, a[1] -= l),
            a
        },
        getRect: function(e) {
            if (e.__rect) return e.__rect;
    ...
    return t.prototype = {
        ...
        buildPath: function(e, t) {
            ...
            d = Math.ceil(n / h), m = i[0] instanceof Array, c = t.size ? t.size: 2, p = c, u = c / 2, V = 2 * Math.PI, U = 0; d > U; U++) {
                ...
                o = a + h,
                o = o > n ? n: o;
                for (var y = a; o > y; y++) if (t.random && (r = t["randomMap" + y % 20] / 100, p = c * r * r, u = p / 2), m ? (s = i[y][0], l = i[y][1]) : (s = i[y].x, l = i[y].y), 3 > p) e.rect(s - u, l - u, p, p);
...
function(e) {
    ...
    function p(e, t, i, n, a) {
        ...
        }).start(a || "QuinticOut")) : (i.style.pointList = t ? t.style.pointList: [[i.style.xStart, i.style.yStart], [i.style.xStart, i.style.yStart]], e.addShape(i), e.animate(i.id, "style").when(n, {
...
define("zrender/shape/Heart", ["require", "./Base", "./util/PathProxy", "zrender/tool/area", "../tool/util"],
function(e) {
    "use strict";
    var t = e("./Base"),
    i = e("./util/PathProxy"),
...
define("zrender/shape/Droplet", ["require", "./Base", "./util/PathProxy", "zrender/tool/area", "../tool/util"],
function(e) {
    "use strict";
    var t = e("./Base"),
    i = e("./util/PathProxy"),
        ...
        buildPath: function(e, t) {
            ...
            if (! (o.length < 2)) {
                ...
                if (t.smooth && "spline" !== t.smooth) {
                    ...
                    for (var l, h, d, m = 0; r - 1 > m; m++) l = s[2 * m],
                    h = s[2 * m + 1],
                    d = o[m + 1],
...
function(e) {
    ...
    return o.prototype = {
        ...
        brush: function(e, t) {
            ...
            this.setContext(e, i),
            this.setTransform(e);
            var n = !1; ("fill" == i.brushType || "both" == i.brushType || "undefined" == typeof i.brushType) && (e.beginPath(), "dashed" == i.lineType || "dotted" == i.lineType ? (this.buildPath(e, {
                lineType: "solid",
                lineWidth: i.lineWidth,
                pointList: i.pointList
            }), n = !1) : (this.buildPath(e, i), n = !0), e.closePath(), e.fill()),
            i.lineWidth > 0 && ("stroke" == i.brushType || "both" == i.brushType) && (n || (e.beginPath(), this.buildPath(e, i)), e.stroke()),
            this.drawText(e, i, this.style),
            e.restore()
        },
        buildPath: function(e, t) {
    ...
    return t.prototype = {
        ...
        _optionToContent: function() {
            ...
            if (this.option.xAxis) for (s = this.option.xAxis instanceof Array ? this.option.xAxis: [this.option.xAxis], e = 0, a = s.length; a > e; e++) if ("category" == (s[e].type || "category")) {
                for (r = [], t = 0, i = s[e].data.length; i > t; t++) o = s[e].data[t],
            ...
            for (e = 0, a = d.length; a > e; e++) {
                ...
                d[e].type == n.CHART_TYPE_SCATTER && (o = "undefined" != typeof o.value ? o.value: o, o = o.join(", ")),
        ...
        _save: function() {
            ...
            if ("function" != typeof t) {
                e = e.split("\n");
                for (var i = [], a = 0, o = e.length; o > a; a++) e[a] = this._trim(e[a]),
                "" !== e[a] && i.push(e[a]);
    ...
    return t.prototype = {
        ...
        axisBase: {
            _buildAxisLine: function() {
                ...
                "" !== this.option.name && (i.style.text = this.option.name, i.style.textPosition = this.option.nameLocation, i.style.textFont = this.getFont(this.option.nameTextStyle), this.option.nameTextStyle.align && (i.style.textAlign = this.option.nameTextStyle.align), this.option.nameTextStyle.baseline && (i.style.textBaseline = this.option.nameTextStyle.baseline), this.option.nameTextStyle.color && (i.style.textColor = this.option.nameTextStyle.color)),
...
function(e) {
    ...
    return t.prototype = {
        ...
        _backupData: function() {
            ...
            s.data && s.data[0] && s.data[0] instanceof Array && (s.type == r.CHART_TYPE_SCATTER || s.type == r.CHART_TYPE_LINE || s.type == r.CHART_TYPE_BAR) && (this._backupScale(), this._calculScatterMap(h[i]))
        },
        ...
        _buildBackground: function() {
            ...
            for (var c, p = this._zoom.seriesIndex[0], u = this._originalData.series[p], V = Number.MIN_VALUE, U = Number.MAX_VALUE, l = 0, h = u.length; h > l; l++) c = null != u[l] ? null != u[l].value ? u[l].value: u[l] : 0,
            ...
            for (var l = 0,
            h = i; h > l; l += _) c = null != u[l] ? null != u[l].value ? u[l].value: u[l] : 0,
            this.option.series[p].type == r.CHART_TYPE_K && (c = c[1]),
            isNaN(c) && (c = 0),
            g.push("horizontal" == this.zoomOption.orient ? [this._location.x + f * l, this._location.y + t - 1 - Math.round((c - U) / y * (t - 10))] : [this._location.x + 1 + Math.round((c - U) / y * (e - 10)), this._location.y + b * l]);
            "horizontal" == this.zoomOption.orient ? (g.push([this._location.x + e, this._location.y + t]), g.push([this._location.x, this._location.y + t])) : (g.push([this._location.x, this._location.y + t]), g.push([this._location.x, this._location.y])),
            this.shapeList.push(new a({
                zlevel: this._zlevelBase,
                style: {
                    pointList: g,
        ...
        _syncFrameShape: function() {
            "horizontal" == this.zoomOption.orient ? (this._startFrameShape.style.width = this._fillerShae.style.x - this._location.x, this._endFrameShape.style.x = this._fillerShae.style.x + this._fillerShae.style.width, this._endFrameShape.style.width = this._location.x + this._location.width - this._endFrameShape.style.x) : (this._startFrameShape.style.height = this._fillerShae.style.y - this._location.y, this._endFrameShape.style.y = this._fillerShae.style.y + this._fillerShae.style.height, this._endFrameShape.style.height = this._location.y + this._location.height - this._endFrameShape.style.y),
        ...
        _syncData: function(e) {
            ...
            for (var s in this._originalData) {
                ...
                null != o && (a = o.length, i = Math.floor(this._zoom.start / 100 * a), n = Math.ceil(this._zoom.end / 100 * a), this.option[s][l].data[0] instanceof Array && this.option[s][l].type != r.CHART_TYPE_K ? (this._setScale(), this.option[s][l].data = this._synScatterData(l, o)) : this.option[s][l].data = o.slice(i, n))
            }
...
function(e) {
    ...
    return t.prototype = {
        ...
        _buildAxisTick: function() {
            ...
            d = h > 0 ? -s: 0;
            if (this.isHorizontal()) for (var m, c = "bottom" == this.option.position ? i.inside ? this.grid.getYend() - n - 1 : this.grid.getYend() + 1 : i.inside ? this.grid.getY() + 1 : this.grid.getY() - n - 1, p = d; t > p; p += s) m = this.subPixelOptimize(this.getCoordByIndex(p) + (p >= 0 ? h: 0), r),
            e = {
                _axisShape: "axisTick",
                zlevel: this._zlevelBase,
                hoverable: !1,
            ...
            else for (var u, V = "left" == this.option.position ? i.inside ? this.grid.getX() + 1 : this.grid.getX() - n - 1 : i.inside ? this.grid.getXend() - n - 1 : this.grid.getXend() + 1, p = d; t > p; p += s) u = this.subPixelOptimize(this.getCoordByIndex(p) - (p >= 0 ? h: 0), r),
            e = {
                _axisShape: "axisTick",
                zlevel: this._zlevelBase,
                hoverable: !1,
        ...
        _buildAxisLabel: function() {
            ...
            if (this.isHorizontal()) {
                ...
                for (var c = 0; a > c; c += this._interval)"" !== this._getReformedLabel(c) && (t = s.merge(i[c].textStyle || {},
                h), e = {
                    zlevel: this._zlevelBase,
                    hoverable: !1,
                    style: {
        ...
        _buildSplitLine: function() {
            ...
            l = i.onGap,
            h = l ? this.getGap() / 2 : "undefined" == typeof l && this.option.boundaryGap ? this.getGap() / 2 : 0;
            if (t -= l || "undefined" == typeof l && this.option.boundaryGap ? 1 : 0, this.isHorizontal()) for (var d, m = this.grid.getY(), c = this.grid.getYend(), p = 0; t > p; p += this._interval) d = this.subPixelOptimize(this.getCoordByIndex(p) + h, o),
            e = {
                zlevel: this._zlevelBase,
                hoverable: !1,
                style: {
            ...
            this.shapeList.push(new a(e));
            else for (var u, V = this.grid.getX(), U = this.grid.getXend(), p = 0; t > p; p += this._interval) u = this.subPixelOptimize(this.getCoordByIndex(p) - h, o),
            e = {
                zlevel: this._zlevelBase,
                hoverable: !1,
                style: {
        ...
        _buildSplitArea: function() {
            ...
            if (i instanceof Array) {
                ...
                if (this.isHorizontal()) for (var l, h = this.grid.getY(), d = this.grid.getHeight(), m = this.grid.getX(), c = 0; a >= c; c += this._interval) l = a > c ? this.getCoordByIndex(c) + s: this.grid.getXend(),
                e = {
                    zlevel: this._zlevelBase,
                    hoverable: !1,
                    style: {
                ...
                m = l;
                else for (var p, u = this.grid.getX(), V = this.grid.getWidth(), U = this.grid.getYend(), c = 0; a >= c; c += this._interval) p = a > c ? this.getCoordByIndex(c) - s: this.grid.getY(),
                e = {
                    zlevel: this._zlevelBase,
                    hoverable: !1,
                    style: {
        ...
        refresh: function(e) {
            e && (this.option = this.reformOption(e), this.option.axisLabel.textStyle = s.merge(this.option.axisLabel.textStyle || {},
            this.ecTheme.textStyle)),
            this.clear(),
            this._buildShape()
        },
        ...
        getIndexByName: function(e) {
            for (var t = this.option.data,
            i = t.length,
            n = 0; i > n; n++) if (t[n] == e || "undefined" != typeof t[n].value && t[n].value == e) return n;
            return - 1
        },
    ...
    return t.prototype = {
        ...
        _calculSum: function(e, t) {
            ...
            if (this.series[t].stack) {
                ...
                for (var h = 0,
                d = n.length; d > h; h++) i = null != n[h].value ? n[h].value: n[h],
...
function() {
    ...
    function m(e, i, n) {
        ...
        d = o - i.c,
        m = h - d;
        return m >= 2 * s && (m = X(m / s) * s, r += m, o += m),
        e.c = r,
        i.c = o,
        s
    }
