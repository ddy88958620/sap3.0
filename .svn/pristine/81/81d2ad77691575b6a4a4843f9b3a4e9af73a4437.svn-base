...
<div style="position:absolute;top:0px;bottom:0px;left:0px;right:0px;height:100%; padding:20px;" >
		...
		<div>
			<div class="tab-content" style="width:99%;top:54px;bottom:0px;position:absolute;margin-left:3px">
...
<div class="modal fade" id="viewResult" tabindex="-1" role="dialog" aria-labelledby="myModalLabel" aria-hidden="true" >
   <div class="modal-dialog" style="width:100%;height:auto;">
      <div class="modal-content" style="width:50%;height:auto;margin-left:25%">
...
function getAllRecord(){
	...
	var aoColumns = [
	                      ...
	                      {  
		                        ...
		                        "render": function ( data, type, full, meta ) {
		                        	  var button = "<a href=# onclick='viewResult(\"" + full.uuid + "\")'><b>查看结果</b></a>";
		                        	  return button;
		                    	  }
		                    }
		];
	...
	nowDataTable = $('#dataTable').dataTable({
	     ...
	     "scrollY": tabContent,
		 "order": [[ 0, 'asc' ]],
		 "sAjaxSource": "../qualityResult/dataGrid",
